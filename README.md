...
| `kafka.producerOptions`                               | `Object`                         | `null`                  | Kafka              | Additional `@platformatic/kafka` [producer configuration](https://github.com/platformatic/kafka/blob/main/docs/producer.md).                                                                                                       |
| `kafka.consumerOptions`                               | `Object`                         | `null`                  | Kafka              | Additional `@platformatic/kafka` [consumer configuration](https://github.com/platformatic/kafka/blob/main/docs/consumer.md).                                                                                                       |

### Redis Streams

[Redis Streams](https://redis.io/topics/streams-intro) was introduced in Redis 5.0. However, since this module relies on the [XAUTOCLAIM](https://redis.io/commands/xautoclaim) command, Redis >= 6.2.0 is required.
...
> To use this adapter, install the [`@platformatic/kafka`](https://github.com/platformatic/kafka) and [hwp](https://github.com/mcollina/hwp), for parallel processing aka max-in-flight, with the following command `npm install @platformatic/kafka hwp`
