...
module.exports = {
    ...
    channels: {
        ...
        "payment.processed": {
            ...
            group: "other",
            // validate the payload before processing the message.
            params: {
                id: "number",
                name: "string",
                status: "boolean",
...
| `params`                                    | `Object`                                  | \*                 | Validation schema just as in [action params](https://moleculer.services/docs/0.15/validating#Actions-Validation). Note that failed validation counts to the message retries.                                      |
