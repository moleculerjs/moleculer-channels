...
| `amqp.exchangeType`                    | `string`                                  | AMQP               | AMQP lib exchange configuration. More info [here](http://www.squaremobius.net/amqp.node/channel_api.html#channel_assertExchange).
            ...
            adapter: {
                ...
                options: {
                    amqp: {
                        ...
                        exchangeOptions: {},
                        // Type for `assertExchange()` default to fanout
                        exchangeType: null,
